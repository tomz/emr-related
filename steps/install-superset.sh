...
superset init
cd ~/.superset
sqlite3 superset.db "INSERT INTO dbs (created_on,changed_on,id,database_name,sqlalchemy_uri,created_by_fk,changed_by_fk,password,cache_timeout,extra,select_as_create_table_as,allow_ctas,expose_in_sqllab,force_ctas_schema,allow_run_async,allow_run_sync,allow_dml,perm,verbose_name,impersonate_user,allow_multi_schema_metadata_fetch) VALUES(date('now'),date('now'),2,'Hive','hive://localhost:10000',1,1,NULL,NULL,'{\"metadata_params\": {},\"engine_params\": {}}',0,1,1,'',0,1,1,'[Hive].(id:2)',NULL,1,1);"
sqlite3 superset.db "INSERT INTO dbs (created_on,changed_on,id,database_name,sqlalchemy_uri,created_by_fk,changed_by_fk,password,cache_timeout,extra,select_as_create_table_as,allow_ctas,expose_in_sqllab,force_ctas_schema,allow_run_async,allow_run_sync,allow_dml,perm,verbose_name,impersonate_user,allow_multi_schema_metadata_fetch) VALUES(date('now'),date('now'),3,'Spark','hive://localhost:10001',1,1,NULL,NULL,'{\"metadata_params\": {},\"engine_params\": {}}',0,1,1,'',0,1,1,'[Spark].(id:3)',NULL,1,1);"
sqlite3 superset.db "INSERT INTO dbs (created_on,changed_on,id,database_name,sqlalchemy_uri,created_by_fk,changed_by_fk,password,cache_timeout,extra,select_as_create_table_as,allow_ctas,expose_in_sqllab,force_ctas_schema,allow_run_async,allow_run_sync,allow_dml,perm,verbose_name,impersonate_user,allow_multi_schema_metadata_fetch) VALUES(date('now'),date('now'),4,'Presto','presto://localhost:8889/hive/default',1,1,NULL,NULL,'{\"metadata_params\": {},\"engine_params\": {}}',0,1,1,'',0,1,1,'[Presto].(id:4)',NULL,1,1);"
